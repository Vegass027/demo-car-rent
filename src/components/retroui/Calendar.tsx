...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background w-full outline-2 shadow-md group/calendar p-3 pb-5 sm:[--cell-size:--spacing(9)] [--cell-size:--spacing(10)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        root: cn("w-full lg:w-fit", defaultClassNames.root),
        months: cn(
